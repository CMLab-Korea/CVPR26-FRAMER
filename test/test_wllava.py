...
from pipelines.pipeline_framer import StableDiffusion3ControlNetPipeline
...
def load_framer_pipeline(args, accelerator):
...
def main(args):
    ...
    if accelerator.is_main_process:
        accelerator.init_trackers("framer")

    pipeline = load_framer_pipeline(args, accelerator)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--transformer_model_name_or_path", type=str, default='framer_q')
